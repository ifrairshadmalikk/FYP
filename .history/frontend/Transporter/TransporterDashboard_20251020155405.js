        ...
        <View style={styles.header}>
          ...
          <View style={styles.welcomeSection}>
            ...
            <View style={styles.efficiencyBadge}>
              ...
              <Text style={styles.efficiencyText}>{managerProfile.efficiency}% Efficiency</Text>
            </View>
          </View>
        </View>
        ...
        <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            <View style={styles.cardHeader}>
              ...
              <Text style={styles.cardSubtitle}>Weekly performance insights</Text>
            </View>
            <View style={styles.performanceContainer}>
              ...
              <View style={styles.performanceItem}>
                <View style={styles.performanceIcon}>
                  <Ionicons name="happy" size={24} color="#3498DB" />
                </View>
                <View style={styles.performanceText}>
                  <Text style={styles.performanceValue}>4.8/5</Text>
                  <Text style={styles.performanceLabel}>Passenger Rating</Text>
                </View>
              </View>
              <View style={styles.performanceItem}>
                <View style={styles.performanceIcon}>
                  ...
                  <View style={styles.profileInfo}>
                    ...
                    <View style={styles.profileStats}>
                      ...
                      <View style={styles.profileStat}>
                        ...
                        <Text style={styles.profileStatText}>{managerProfile.efficiency}%</Text>
                      </View>
                    </View>
                  </View>
