    ...
    <SafeAreaView style={profileStyles.container}>
      ...
      <ScrollView style={profileStyles.scrollContent}>
        ...
        <View style={profileStyles.profileHeader}>
          ...
          />
          <Text style={profileStyles.name}>{driverProfile.name}</Text>
          <Text style={profileStyles.role}>{driverProfile.role}</Text>
          <View style={profileStyles.ratingContainer}>
            <Ionicons name="star" size={20} color="#F39C12" />
            <Text style={profileStyles.rating}>{driverProfile.rating}</Text>
          </View>
        </View>
        ...
        <View style={profileStyles.statsContainer}>
          <View style={profileStyles.statCard}>
            ...
            <Text style={profileStyles.statNumber}>{driverProfile.totalRoutes}</Text>
            <Text style={profileStyles.statLabel}>Routes</Text>
          </View>
          <View style={profileStyles.statCard}>
            <Ionicons name="checkmark-done" size={24} color="#27AE60" />
            <Text style={profileStyles.statNumber}>{driverProfile.completedTrips}</Text>
            <Text style={profileStyles.statLabel}>Trips</Text>
          </View>
          <View style={profileStyles.statCard}>
            <Ionicons name="time" size={24} color="#F39C12" />
            <Text style={profileStyles.statNumber}>{driverProfile.experience}</Text>
            <Text style={profileStyles.statLabel}>Experience</Text>
          </View>
        </View>
        ...
        <View style={profileStyles.section}>
          ...
          <View style={profileStyles.infoCard}>
            <View style={profileStyles.infoItem}>
              ...
              <Text style={profileStyles.infoValue}>{driverProfile.phone}</Text>
            </View>
            <View style={profileStyles.infoItem}>
              <Ionicons name="mail-outline" size={20} color="#7F8C8D" />
              <Text style={profileStyles.infoLabel}>Email</Text>
              <Text style={profileStyles.infoValue}>{driverProfile.email}</Text>
            </View>
            <View style={profileStyles.infoItem}>
              <Ionicons name="calendar-outline" size={20} color="#7F8C8D" />
              <Text style={profileStyles.infoLabel}>Joined</Text>
              <Text style={profileStyles.infoValue}>{driverProfile.joinedDate}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={profileStyles.section}>
          ...
          <View style={profileStyles.actionsCard}>
            {[
              ...
              <TouchableOpacity key={index} style={profileStyles.actionItem}>
                <View style={[profileStyles.actionIcon, { backgroundColor: `${action.color}15` }]}>
                  <Ionicons name={action.icon} size={20} color={action.color} />
                </View>
                <Text style={profileStyles.actionText}>{action.label}</Text>
