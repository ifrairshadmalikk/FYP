        ...
        <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.actionsGrid}>
              {[
                { id: "1", label: "Ride Planner", icon: "send-outline", nav: "CreatePoll", color: "#afd826" },
                { id: "2", label: "Responses", icon: "reader-outline", nav: "ViewResponses", color: "#afd826" },
                { id: "3", label: "Assign Route", icon: "map-outline", nav: "AssignRoute", color: "#afd826" },
                { id: "4", label: "Live Tracking", icon: "location-outline", nav: "VanTracking", color: "#afd826" },
                { id: "5", label: "Analytics", icon: "bar-chart-outline", nav: "Analytics", color: "#afd826" },
                { id: "6", label: "Reports", icon: "document-text-outline", nav: "Reports", color: "#afd826" },
              ].map((action) => (
                <TouchableOpacity
                  key={action.id}
                ...
                >
                  <View style={[styles.actionIcon, { backgroundColor: "#f0f9e0" }]}>
...
const styles = StyleSheet.create({
  ...
  // Quick Actions - 3x2 Grid
  // Quick Actions - Original Style with Colorful Icons Only
  actionsGrid: {
    flexDirection: "row",
    flexWrap: "wrap",
    justifyContent: "space-between",
  ...
  actionIcon: {
    ...
    alignItems: "center",
    marginBottom: 8,
    backgroundColor: "#81a83cff", // Keep original background
  },
  actionText: {
    fontSize: 12,
    fontWeight: "600",
    color: "#2C3E50", // Keep original text color
    textAlign: "center",
  },
