...
export default function TransporterDashboard() {
  ...
  // Utilization animation - FIXED LINE
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          {/* Quick Actions - 3x2 Grid with Beautiful Colorful Icons */}
          <View style={styles.card}>
              ...
              {[
                ...
                >
                  <View style={[styles.actionIconContainer, { backgroundColor: action.iconBg }]}>
                    <View style={[styles.actionIconWrapper, { borderColor: action.color }]}>
...
const styles = StyleSheet.create({
  ...
  // Enhanced Quick Actions - 3x2 Grid with Beautiful Icons
  actionsGrid: {
    flexDirection: "row",
    flexWrap: "wrap",
    justifyContent: "space-between",
