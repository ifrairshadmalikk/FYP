...
export default function AssignRoutesScreen({ navigation }) {
    ...
    const [showDriverRoute, setShowDriverRoute] = useState(null);
        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.mapHeader}>
                ...
                <View style={styles.headerTitleContainer}>
                    <Text style={styles.headerTitle}>Live Routes Overview</Text>
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        {drivers.map(driver => {
                            ...
                            return (
                                <TouchableOpacity
                                    key={driver.id}
                                    style={[styles.driverInfoCard, { borderLeftColor: driver.color }]}
                                    onPress={() => {
                                        setSelectedDriver(driver);
                                        setShowDriverRoute(driver.id);
                                    }}
                                >
        ...
        >
            <SafeAreaView style={styles.modalContainer}>
                <View style={styles.modalHeader}>
                    <TouchableOpacity 
                        style={styles.backButton}
                        onPress={() => setShowDriverRoute(null)}
                    >
                        <Ionicons name="close" size={24} color="#333" />
                    </TouchableOpacity>
                    <Text style={styles.modalTitle}>
                        {drivers.find(d => d.id === showDriverRoute)?.name}'s Route
                    </Text>
                ...
                <ScrollView style={styles.modalContent}>
                    <View style={styles.routeDetails}>
                        <Text style={styles.routeSectionTitle}>Route Details</Text>
                        <View style={styles.routeInfo}>
                            <View style={styles.routeInfoItem}>
                                <Ionicons name="car" size={20} color="#3498DB" />
                                <Text style={styles.routeInfoText}>
                                    {drivers.find(d => d.id === showDriverRoute)?.vehicle}
                                </Text>
                            </View>
                            <View style={styles.routeInfoItem}>
                                <Ionicons name="people" size={20} color="#27AE60" />
                                <Text style={styles.routeInfoText}>
                                    {getDriverAssignments(showDriverRoute)} passengers
                                </Text>
                            </View>
                            <View style={styles.routeInfoItem}>
                                <Ionicons name="time" size={20} color="#F39C12" />
                                <Text style={styles.routeInfoText}>
                                    {estimatedTimes[showDriverRoute]?.totalTime} total
                                </Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.stopsList}>
                        <Text style={styles.routeSectionTitle}>Pickup Stops</Text>
                        {getAssignedPassengersForDriver(showDriverRoute).map((passenger, index) => (
                            <View key={passenger.id} style={styles.stopItem}>
                                <View style={[styles.stopNumber, { backgroundColor: drivers.find(d => d.id === showDriverRoute)?.color }]}>
            ...
            >
                <View style={styles.actionsMenu}>
                    ...
                    >
                        ...
                        <Text style={styles.menuItemText}>Live View</Text>
                    </TouchableOpacity>
                </View>
            </TouchableOpacity>
        </Modal>
            ...
            <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.destinationBanner}>
                    ...
                    >
                        ...
                        <Text style={styles.viewMapText}>Live Map</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.quickStats}>
                    ...
                    <View style={styles.statCard}>
                        ...
                        <Text style={styles.statNumber}>{Object.keys(assignments).length}</Text>
                                        ...
                                        <View style={styles.routePreview}>
                                            <View style={styles.routePreviewHeader}>
                                                ...
                                                <TouchableOpacity 
                                                    ...
                                                    onPress={() => setShowDriverRoute(driver.id)}
                                                >
