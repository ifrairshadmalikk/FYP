          ...
          <View style={styles.filterSection}>
            ...
            <View style={styles.filterOptions}>
              {typeOptions.map((type) => (
                ...
                >
                  <Ionicons 
                    name={type === "passenger" ? "person" : type === "driver" ? "car" : "people"} 
                    size={16} 
          ...
          <View style={styles.filterSection}>
            ...
            <View style={styles.filterOptions}>
              {statusOptions.map((status) => (
                ...
                >
                  <Ionicons 
                    name={status === "paid" ? "checkmark-circle" : status === "pending" ? "time" : "list"} 
                    size={16} 
              ...
              {methodOptions.map((method) => (
                ...
                >
                  <Ionicons 
                    name="card" 
                    size={16} 
                    color={selectedMethod === method ? "#fff" : "#666"} 
                  />
                  <Text style={[
                    styles.filterOptionText,
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={styles.statDivider} />
        <View style={styles.statItem}>
          <Text style={styles.statNumber}>{passengerPayments}</Text>
          <Text style={styles.statLabel}>Passengers</Text>
        </View>
        <View style={styles.statDivider} />
        <View style={styles.statItem}>
          <Text style={styles.statNumber}>{driverPayments}</Text>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        {filteredPayments.map((item) => (
          <View key={item.id} style={[
            ...
            item.type === "driver" && styles.driverCard
          ]}>

            {/* Type Badge */}
            <View style={[
              styles.typeBadge,
              item.type === "passenger" ? styles.passengerBadge : styles.driverTypeBadge
            ]}>
              <Ionicons 
              ...
              <Text style={styles.typeText}>
                {item.type === "passenger" ? "Passenger" : "Driver"}
              </Text>
            </View>
            ...
            <View style={styles.paymentInfo}>
              <Ionicons 
                name={item.type === "passenger" ? "person-circle" : "car-sport"} 
                size={40} 
                color={item.type === "passenger" ? "#afd826" : "#4C51BF"} 
              />
              <View style={styles.paymentDetails}>
                <Text style={styles.name}>{item.name}</Text>
                <Text style={styles.counterpart}>
                  {item.type === "passenger" ? "Driver: " : "Passenger: "}{item.counterpart}
                </Text>
                <View style={styles.paymentMeta}>
                  <Text style={styles.amount}>{item.amount}</Text>
                  <Text style={styles.date}>{item.date}</Text>
                </View>
                <Text style={styles.method}>via {item.paymentMethod}</Text>
              </View>
            </View>
