...
export default function VanTrackingScreen({ navigation, route }) {
  ...
  // Initialize vans from assigned drivers - useCallback lagayein
  useEffect(() => {
  ...
  // Fake live update with more realistic movement - useCallback lagayein
  useEffect(() => {
